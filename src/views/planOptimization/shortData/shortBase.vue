<template>
  <div class="short-basic-data">
    <div class="header">短周期基础数据</div>
            ...
            <a-row class="row">
              <div class="left">
                ...
                <a-upload
                  ...
                  name="file"
                  :multiple="false"
                  action="/huali-api/File/UploadTBMSP"
                  @change="handleChange"
                >
                  <a-button shape="round" class="btn"> <a-icon type="upload" /> 上传TBM表</a-button>
                </a-upload>
                <!-- 上传效益测算文件 -->
                <a-upload
                  style="display: inline-block;"
...
<script>
import { analyseTBM, getTableData, updateConfig } from '@/api/dataCenterSP'
  ...
  data () {
    return {
      ...
      menuList: [
        ...
        { key: '1', name: '原油表', path: '/planOptimization/shortData/shortBase/oilTable' },
